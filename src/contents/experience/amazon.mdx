...
description: [
    "Constructed a feature to implement alias resolution with Java which allows customers
    to replicate AWS Lambda and Amazon Lex configurations from current region to other regions.
